...
## Project objectives
The project represents a recommendation system for alternative drugs based on data similarity. Given a drug as input, the system will recommend similar drugs, taking into account the similarity of indications and concentration.
